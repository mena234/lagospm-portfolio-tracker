# LagosPM Portfolio Tracker: developer guide

[Back to the project overview](README.md) · [Live demo](https://project-tracker.ramzy.tech/)
...
The repository includes representative development data and an import path. Reconciliation against a real portfolio requires the matching source export.
